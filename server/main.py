...
def source_health_metrics() -> dict[str, object]:
    ...
    return {
        ...
        "bundle_channel_stats": payload.get("bundle_channel_stats", {}),
        "bundle_channel_failure_threshold": payload.get("bundle_channel_failure_threshold", 3),
        "bundle_channel_failure_penalty": payload.get("bundle_channel_failure_penalty", 30),
        },
    }
...
def policy_state() -> dict[str, object]:
    ...
    return {
        ...
        "bundle_channel_stats": payload["bundle_channel_stats"],
        "bundle_channel_failure_threshold": payload["bundle_channel_failure_threshold"],
        "bundle_channel_failure_penalty": payload["bundle_channel_failure_penalty"],
